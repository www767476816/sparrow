...
func (this *Base) RegisterRpcService() {
	//注册服务器
	msg_server.RegisterRpcServiceServer(this.Frame.GetRpcServer().GetConnect(), new(ItemRpc))
}
...
func (this *ItemRpc) RegisterService(ctx context.Context, req *msg_server.RegisterServiceRequest) (*msg_server.RegisterServiceResponse, error) {

	return &msg_server.RegisterServiceResponse{}, nil
}

func (this *ItemRpc) QueryServiceList(ctx context.Context, req *google_protobuf.Empty) (*msg_server.QueryServiceListResponse, error) {

	return &msg_server.QueryServiceListResponse{}, nil
}
func (this *ItemRpc) UpdateServiceList(ctx context.Context, req *msg_server.UpdateServiceListRequest) (*google_protobuf.Empty, error) {
