 ...
 * @LastEditTime: 2021-12-27 17:23:36
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \sparrow\logic_server\base\rpc.go
 */
package base
...
func (this *Base) RegisterRpcService() {
	//注册服务器
	rpc_protocol.RegisterRpcServiceServer(this.Frame.GetRpcServer().GetConnect(), new(LogicRpc))
}
...
func (this *LogicRpc) RegisterService(ctx context.Context, req *rpc_protocol.RegisterServiceRequest) (*rpc_protocol.RegisterServiceResponse, error) {

	return &rpc_protocol.RegisterServiceResponse{}, nil
}

func (this *LogicRpc) QueryServiceList(ctx context.Context, req *google_protobuf.Empty) (*rpc_protocol.QueryServiceListResponse, error) {

	return &rpc_protocol.QueryServiceListResponse{}, nil
}
func (this *LogicRpc) UpdateServiceList(ctx context.Context, req *rpc_protocol.UpdateServiceListRequest) (*google_protobuf.Empty, error) {
