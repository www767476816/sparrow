 ...
 * @LastEditTime: 2021-12-27 17:22:16
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \sparrow\chat_server\base\rpc.go
 */
package base
...
func (this *Base) RegisterRpcService() {
	//注册服务器
	msg_server.RegisterRpcServiceServer(this.Frame.GetRpcServer().GetConnect(), new(ChatRpc))
}
...
func (this *ChatRpc) RegisterService(ctx context.Context, req *msg_server.RegisterServiceRequest) (*msg_server.RegisterServiceResponse, error) {

	return &msg_server.RegisterServiceResponse{}, nil
}

func (this *ChatRpc) QueryServiceList(ctx context.Context, req *google_protobuf.Empty) (*msg_server.QueryServiceListResponse, error) {

	return &msg_server.QueryServiceListResponse{}, nil
}
func (this *ChatRpc) UpdateServiceList(ctx context.Context, req *msg_server.UpdateServiceListRequest) (*google_protobuf.Empty, error) {
